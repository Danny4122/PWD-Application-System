...
<div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 mt-4 md:mt-0">
  ...
  <div class="flex items-center gap-4">
    <img src="pdao_logo.png" alt="PWD Logo" class="w-32 h-32 object-contain" />
    <img src="iligan_logo.png" alt="Iligan Logo" class="w-32 h-32 object-contain" />
  </div>
  ...
  <div class="max-w-7xl mx-auto">
    ...
    <div class="flex justify-center gap-5 mb-6"> <!-- Adjusted gap for better spacing between buttons -->
      ...
      <a href="new_registration.php" class="bg-blue-800 text-white font-semibold px-8 py-6 rounded-lg shadow-md hover:bg-blue-800 transition w-56 sm:w-64 flex flex-col items-center">
        <img src="newreg.png" alt="New Registration" class="w-16 h-16 mb-3" /> <!-- Adjusted icon size -->
      ...
      <a href="renew_id.php" class="bg-blue-800 text-white font-semibold px-8 py-6 rounded-lg shadow-md hover:bg-blue-800 transition w-56 sm:w-64 flex flex-col items-center">
        <img src="renew.png" alt="Renew ID" class="w-16 h-16 mb-3" /> <!-- Adjusted icon size -->
      ...
      <a href="lost_id.php" class="bg-blue-800 text-white font-semibold px-8 py-6 rounded-lg shadow-md hover:bg-blue-800 transition w-56 sm:w-64 flex flex-col items-center">
        <img src="lostid.png" alt="Lost ID" class="w-16 h-16 mb-3" /> <!-- Adjusted icon size -->
      ...
      <a href="check_status.php" class="bg-blue-800 text-white font-semibold px-8 py-6 rounded-lg shadow-md hover:bg-blue-800 transition w-56 sm:w-64 flex flex-col items-center">
        <img src="checkstatus.png" alt="Check Status" class="w-16 h-16 mb-3" /> <!-- Adjusted icon size -->
...
<section class="w-full bg-gradient-to-r from-blue-700 to-blue-900 text-white text-center py-20 px-6 mt-60">
    ...
    <a href="#qualifications" class="mt-8 inline-block bg-[#4177B2] text-white font-semibold px-8 py-3 rounded-[30px] shadow border border-black hover:bg-[#3577e6] transition">
      Get Started
    </a>
  </section>
...
<section id="qualifications" class="py-20 px-4 bg-white text-center mt-16">
  ...
  <div class="bg-blue-50 max-w-md mx-auto p-10 rounded-lg shadow-lg text-left space-y-4 text-sm leading-relaxed border border-blue-200" style="box-shadow: 0px 4px 12px rgba(0, 0, 0, 0.1);">
    <p><img src="check.png" alt="Check" class="w-4 h-4 inline-block" /> Must be 59 years old or below</p>
    <p><img src="check.png" alt="Check" class="w-4 h-4 inline-block" /> Resident of Iligan City only</p>
    <p><img src="check.png" alt="Check" class="w-4 h-4 inline-block" /> Must be a Filipino citizen</p>
    <p><img src="check.png" alt="Check" class="w-4 h-4 inline-block" /> Must have a specific type of disability</p>
  </div>
</section>
...
<section id="requirements" class="py-20 px-4 bg-white mt-10 mb-20">
  ...
  <div class="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto text-sm">
    ...
    <img src="new_icon.png" alt="New" class="w-6 h-6" />
        <h4 class="text-blue-700 font-semibold text-lg mb-3">New Application</h4>
      </div>
      <p><img src="check.png" alt="Check" class="w-4 h-4 inline-block" /> Filled-out registration form</p>
      <p><img src="check.png" alt="Check" class="w-4 h-4 inline-block" /> 1 pc 1x1 ID picture</p>
      <p><img src="check.png" alt="Check" class="w-4 h-4 inline-block" /> 1 whole body picture</p>
      <p><img src="check.png" alt="Check" class="w-4 h-4 inline-block" /> Barangay Certificate of Residency / Indigency</p>
      <p><img src="check.png" alt="Check" class="w-4 h-4 inline-block" /> Doctor's Referral / Medical Certificate</p>
      <p><img src="check.png" alt="Check" class="w-4 h-4 inline-block" /> Certificate from City Health Office</p>
    </div>

    <!-- ID Renewal -->
    <div class="bg-blue-50 p-8 rounded-lg shadow border border-blue-200 space-y-4 text-left">
      <div class="flex items-center gap-2">
        <img src="renew_icon.png" alt="Renew" class="w-6 h-6" />
        <h4 class="text-blue-700 font-semibold text-lg mb-3">ID Renewal</h4>
      </div>
      <p><img src="check.png" alt="Check" class="w-4 h-4 inline-block" /> Filled-out registration form</p>
      <p><img src="check.png" alt="Check" class="w-4 h-4 inline-block" /> Surrender old PWD ID</p>
      <p><img src="check.png" alt="Check" class="w-4 h-4 inline-block" /> Barangay Certificate of Residency / Indigency</p>
      <p><img src="check.png" alt="Check" class="w-4 h-4 inline-block" /> Doctor's Referral / Medical Certificate</p>
      <p><img src="check.png" alt="Check" class="w-4 h-4 inline-block" /> Certificate from City Health Office</p>
      <p><img src="check.png" alt="Check" class="w-4 h-4 inline-block" /> 1 pc 1x1 ID picture</p>
    ...
    <div class="bg-blue-50 p-8 rounded-lg shadow border border-blue-200 space-y-4 text-left">
      <div class="flex items-center gap-2">
        <img src="lostid_icon.png" alt="Lost" class="w-6 h-6" />
        <h4 class="text-blue-700 font-semibold text-lg mb-3">Lost ID</h4>
      </div>
      <p><img src="check.png" alt="Check" class="w-4 h-4 inline-block" /> Affidavit of Loss</p>
      <p><img src="check.png" alt="Check" class="w-4 h-4 inline-block" /> Barangay Certificate of Residency / Indigency</p>
      <p><img src="check.png" alt="Check" class="w-4 h-4 inline-block" /> Doctor's Referral / Medical Certificate</p>
      <p><img src="check.png" alt="Check" class="w-4 h-4 inline-block" /> Certificate from City Health Office</p>
      <p><img src="check.png" alt="Check" class="w-4 h-4 inline-block" /> 1 pc 1x1 ID picture</p>
